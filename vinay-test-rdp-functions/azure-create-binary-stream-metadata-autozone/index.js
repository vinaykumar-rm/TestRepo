...
// Version: 18.04
// Last update: April-30-2018, prevent recursion of lambda function during rendition support
...
module.exports = function (context, storageBlob) {
    ...
    var objectKey = context.bindingData.name;
    if (objectKey.indexOf('/') === -1) {
        ...
        if (isDebugEnabled) {
            context.log.info('Bypassing objects under sub-folder to prevent recursion.');
        }
        context.done();
    }
};
